...
export class App {
  ...
  private readonly apiBaseUrl = 'https://tinylink-1dpd.onrender.com';
  ...
  protected readonly qrCodeUrl = computed(() => {
    ...
    return shortUrl
      ? `https://api.qrserver.com/v1/create-qr-code/?size=220x220&format=svg&data=${encodeURIComponent(shortUrl)}`
      : '';
  });
